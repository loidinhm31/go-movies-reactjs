...
const EditMovie = () => {
    ...
    useEffect(() => {
        ...
        if (id === 0) {
            ...
            fetch(`${environment.apiBaseUrl}/genres`, requestOptions)
            ...
            fetch(`${environment.apiBaseUrl}/admin/movies/${id}`, requestOptions)
                .then((response) => {
    ...
    const handleSubmit = (event) => {
        ...
        // Need to covert the values in JSON for release date (to date)
        ...
        fetch(`${environment.apiBaseUrl}/admin/movies/${movie.id}`, requestOptions)
            .then((response) => response.json())
            .then((data) => {
                if (data.error) {
