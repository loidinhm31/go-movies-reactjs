          ...
          <Grid key={e.id} item xs={4}>
            ...
            >
              <Grid container spacing={2}>
                ...
                <Grid item xs={6}>
                  <Typography variant="subtitle1">{format(new Date(e.air_date!), "MMMM do, yyyy")}</Typography>
                </Grid>
                <Grid item xs={12}>
                  <Stack direction="row" spacing={2} sx={{ display: "flex", alignItems: "center" }}>
                    <Typography variant="subtitle2">Runtime</Typography>
                    <Typography variant="subtitle2">{e.runtime} minutes</Typography>
                  </Stack>
                </Grid>
                <Grid item xs={12}>
                  <Stack direction="row" spacing={2} sx={{ display: "flex", alignItems: "center" }}>
                ...
                <Grid item xs={12}>
                  <Stack direction="row" spacing={2} sx={{ display: "flex", alignItems: "center" }}>
                    <Button variant="contained" href={`/movies/episodes/${e.id}?movieId=${season.movie_id}`}>
