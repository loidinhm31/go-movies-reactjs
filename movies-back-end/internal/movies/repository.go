...
type MovieRepository interface {
	...
	FindAllMoviesByType(ctx context.Context, movieType string,
		pageRequest *pagination.PageRequest, page *pagination.Page[*models.Movie]) (*pagination.Page[*models.Movie], error)
